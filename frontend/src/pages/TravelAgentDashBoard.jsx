    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="bg-gray-800 p-4 flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          <button className="border border-yellow-500 text-yellow-500 px-4 py-1 rounded">Login</button>
          <button className="bg-yellow-500 text-gray-800 px-4 py-1 rounded">Signup</button>
        </div>
      </div>
      ...
      <main className="flex-grow p-8 bg-white">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <button className="bg-gray-700 text-gray-200 px-4 py-1 rounded text-sm transition-all duration-300 transform hover:scale-105 hover:bg-gray-600 hover:shadow-md">
              View All Departures
            </button>
          </div>
