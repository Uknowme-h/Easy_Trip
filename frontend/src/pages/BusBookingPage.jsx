...
import { Clock, Calendar, Clock3, MapPin, Phone, Mail, Facebook, Instagram, Twitter } from 'lucide-react';

export default function BusSeatBooking() {
  const [selectedSeats, setSelectedSeats] = useState(['C3', 'C4', 'D3', 'D6']);
  ...
  const getSeatLayout = () => {
    // Define which seats exist in the layout
    // This exactly matches the seats shown in the image
    const seatLayout = [
      // First row
      'A1', 'B1', null, null, 'C1', 'D1',
      // Second row
      'A2', 'B2', null, null, 'C2', 'D2',
      // Third row
      'A3', 'B3', null, null, 'C3', 'D3',
      // Fourth row
      'A4', 'B4', null, null, 'C4', 'D4',
      // Fifth row
      'A5', 'B5', null, null, 'C5', 'D5',
      // Sixth row
      'A6', 'B6', null, null, 'C6', 'D6',
      // Seventh row
      'A7', 'B7', null, null, 'C7', 'D7',
      // Eighth row
      'A8', 'B8', null, null, 'C8', 'D8',
      // Ninth row
      'A9', 'B9', 'E1', 'F1' , 'C9', 'D9',
    ];
    
    // Define booked seats
    const bookedSeats = ['A1', 'A2', 'B1', 'B2', 'E1', 'E2', 'F1', 'F2'];
    ...
    <div className="flex flex-col min-h-screen  w-full font-sans">
      ...
      <main className="flex-1 bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-2 divide-x">
          ...
          <div className="p-8">
            ...
            <div className="mb-6">
              <h2 className="text-lg font-bold">Mountain Express pvt. Ltd.</h2>
              <p className="text-gray-600">Kathmandu to Pokhara</p>
              
              <div className="mt-4">
                <div className="text-xl font-bold">NPR 1,200</div>
                ...
                {seats.map((seat, index) => (
                  seat.id ? (
                    <div 
                      ...
                      className={`w-8 h-8 flex items-center justify-center text-xs font-medium ${getSeatStatusColor(seat.status)} rounded ${seat.status !== 'booked' ? 'cursor-pointer hover:opacity-80' : 'cursor-not-allowed'}`}
                    >
                      {seat.id}
                    </div>
                  ) : (
          ...
          <div className="p-8">
            ...
            <div className="mb-6">
              ...
              <div className="flex space-x-2">
                {selectedSeats.map(seat => (
                  <div key={seat} className="w-8 h-8 flex items-center justify-center bg-yellow-400 rounded text-xs font-medium">
                    {seat}
                  </div>
                ))}
              </div>
            ...
            <div className="border-t border-b py-4 space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-medium">NPR {(selectedSeats.length * seatPrice).toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="max-w-6xl mx-auto grid grid-cols-4 gap-8 px-4">
          <div>
            <div className="text-yellow-500 font-bold text-lg mb-3">EasyTrip</div>
            <p className="text-gray-400 text-sm">
              Making travel planning simple and accessible for everyone in Nepal.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><a href="#" className="hover:text-white">Guesthouses</a></li>
